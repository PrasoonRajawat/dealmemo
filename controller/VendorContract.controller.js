	...
	function(Controller, Filter, FilterOperator, Formatter, MessageBox, MessageToast, Fragment, History, Spreadsheet, exportLibrary) {
		...
		return Controller.extend("com.ui.dealmemolocal.controller.VendorContract", {
			...
			onSelectEpisode: function() {
				...
				vendorContractDetailInfo.episodeVCList = vendorContractDetailInfo.episodeList;
			...
			validateMileStoneData: function() {
				...
				if (statusFlag) {
					for (var oIndex = 0; oIndex < milestones.length; oIndex++) {
						...
						else if(vendorContractDetailInfo.DmCmSet.result.length > 0){
							for ( i = 0 ; i <= vendorContractDetailInfo.DmCmSet.result.length ; i++){
								if(vendorContractDetailInfo.DmCmSet.result[i].Mscompdt != '' ||
								   vendorContractDetailInfo.DmCmSet.result[i].Mscompdt != null ||
								   vendorContractDetailInfo.DmCmSet.result[i].Mscompdt != undefined){
								   		statusFlag = false;
						...
						// vendorContractDetailInfo.DmCmSet.results[0].Mscompdt

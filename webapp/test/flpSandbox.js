		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Deal Memo",
									"targetURL": "#comuidealmemolocal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comuidealmemolocal-display": {
								"semanticObject": "comuidealmemolocal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui.dealmemolocal",
									"url": sap.ui.require.toUrl("com/ui/dealmemolocal")
								}
							}
						}
					}
